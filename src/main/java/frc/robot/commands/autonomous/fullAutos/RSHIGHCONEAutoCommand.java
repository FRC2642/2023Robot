...
public class RSHIGHCONEAutoCommand extends SequentialCommandGroup {
  /** Creates a new TWOCUBESHOOTAutoCommand. */
  public RSHIGHCONEAutoCommand(DriveSubsystem drive, LimelightSubsystem clawLimelight) {
    PiratePath path = new PiratePath("PICKUPRAIL");
