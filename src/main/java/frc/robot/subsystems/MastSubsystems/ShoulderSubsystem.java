...
public class ShoulderSubsystem extends SubsystemBase implements IPositionable<ShoulderSubsystem.ShoulderPosition> {
  ...
  public static final double MIN_DEGREES = 26;
 ...
 // public static double SLOW_DOWN_MIN_ANGLE = 50;
  ...
  public static double getShoulderAngle() {
    return absEncoder.getPosition() * DEGREES_PER_TICK + 322;
  }
  ...
  public enum ShoulderPosition {
    ...
    PLACE_CONE_MID(160),
    PLACE_CONE_HIGH(MIN_DEGREES+30),
    PLACE_FIRST_CONE_HIGH_AUTO(MIN_DEGREES+8),
    PLACE_SECOND_CONE_HIGH_AUTO(MIN_DEGREES + 12),
